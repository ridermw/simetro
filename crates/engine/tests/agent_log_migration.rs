//! P2.A0.5: AgentLog v1 → v2 migration shim — golden-file test.
//!
//! Acceptance criterion from spec §3.0 P2.A0.5:
//!
...
/// "bit-for-bit deterministic" property the spec §3.0 P2.A0.5
