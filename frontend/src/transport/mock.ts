...
// `static` + `snapshot` pair drawn from games/demo-paths.json
// equivalent. Step 17 will animate it. Step 22 swaps in a real Tauri
// transport that shares the same Transport interface.
//
