...
import type { NodeSnapshot } from "../protocol/messages";

const SHAPE_TONES: Record<NodeSnapshot["shape"], string> = {
  circle: "C5",
  square: "E5",
  triangle: "G5",
  diamond: "A5",
...
export function toneForShape(shape: NodeSnapshot["shape"]): string {
